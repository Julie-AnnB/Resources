...
between abundance and grazing.intensity (Figure C). A scatterplot matrix
...
yrs.isolation and year.of.isolation (Figures A & B). After this analysis
the preliminary model (Model 1) was proposed (Figure C-C). Residual
plots were examined to ensure that assumptions of linear regression were
met (Figure K), and potential outliers in Model 1 were assessed (Figure
L). Model 2 was selected using a manual backward stepwise method
(Figure), and then evaluated for its suitability as a linear model for
collected data (Figure). Lastly, a polynomial transformation was added
to the model and assessed, it was found not to be an appropriate fit.
...
![](Abundance_Quarto_Final_files/figure-commonmark/unnamed-chunk-3-1.png)
...
<img
src="Abundance_Quarto_Final_files/figure-commonmark/unnamed-chunk-4-1.png"
style="width:80.0%" />

**Figure A** *Scatterplot Matrix of Abundance and Predictor Variables*

![](Abundance_Quarto_Final_files/figure-commonmark/unnamed-chunk-5-1.png)
...
![](Abundance_Quarto_Final_files/figure-commonmark/unnamed-chunk-7-1.png)
...
![](Abundance_Quarto_Final_files/figure-commonmark/unnamed-chunk-10-1.png)
...
![](Abundance_Quarto_Final_files/figure-commonmark/unnamed-chunk-11-1.png)
...
![](Abundance_Quarto_Final_files/figure-commonmark/unnamed-chunk-12-1.png)
...
coefficients. While the residual plot (Figure Z) shows improvement in
...
![](Abundance_Quarto_Final_files/figure-commonmark/unnamed-chunk-21-1.png)
...
![](Abundance_Quarto_Final_files/figure-commonmark/unnamed-chunk-22-1.png)
...
It seemed that the quadratic term improved the capacity to explain the
relationship between variables (Figure HH). However, the quadratic term
coefficient in the updated model (Model 3) was not significant.
Therefore, to keep the model simple and based on the observations above,
the quadratic term was excluded. The final model, and thus, determinants
of bird abundance were log(patch.area) and grazing.intensity:
...
![](Abundance_Quarto_Final_files/figure-commonmark/unnamed-chunk-24-1.png)
...
![](Abundance_Quarto_Final_files/figure-commonmark/unnamed-chunk-25-1.png)
